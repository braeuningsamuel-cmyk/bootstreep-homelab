...
echo ""
info "=== Einzelcheck ==="
for name in pihole unbound tor websurfx jellyfin ollama hermes open-webui n8n syncthing uptime-kuma nextcloud-aio sonarr radarr prowlarr bazarr sabnzbd heimdall caddy; do
